<?php
	...
	/*Fichier apellant la fonction de création de catégorie. On vérifie que la personne agissant est bien administrateur et on la redirige vers index.php si ce n'est pas le cas.*/
