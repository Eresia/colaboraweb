<?php
	...
	else if(!isset($_POST['category']) || !is_category(intval($_POST['category'])) || !isset($_POST['id']) || !is_url(intval($_POST['id'])) || !isset($_POST['url']) || !isset($_POST['description']) || !((getPost($_POST['id'])['author'] == $_SESSION['id']) || ($_SESSION['group'] >= ADMIN))){
